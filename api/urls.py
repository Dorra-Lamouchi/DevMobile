...
from .views import register, login, update_profile, save_data, get_data_by_id, get_all_data_history, admin_login, delete_user, toggle_user, reset_password, user_list, user_stat, get_user_profile

urlpatterns = [
    path('register/', register, name='register'),
    path('login/', login, name='login'),
    path('update-profile/', update_profile, name='update-profile'),
    path('get-user/', get_user_profile, name='get-user'),
